...
public class StatusBarUtil {
     ...
     * @param activity 需要设置的activity
     */
    public static void setHeaderMode(Activity activity) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        transparentStatusBar(activity);
        setRootView1(activity, false);
    }
     ...
     * @param activity
     */
    public static void setHeaderModeForKeyBoard(Activity activity) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        transparentStatusBar(activity);
        setRootView1(activity, true);
    }

    /**
     * 设置根布局参数
     */
    private static void setRootView1(Activity activity, boolean fitsSysWindow) {
        ViewGroup rootView = (ViewGroup) ((ViewGroup) activity.findViewById(android.R.id.content)).getChildAt(0);
        rootView.setFitsSystemWindows(fitsSysWindow);
    ...
    public static void setStartBarTextColor(Window window, boolean dark) {
