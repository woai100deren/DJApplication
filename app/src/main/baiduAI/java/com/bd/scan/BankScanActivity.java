...
public class BankScanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.general_basic_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(BankScanActivity.this, CameraActivity.class);
        ...
        findViewById(R.id.idcard_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(BankScanActivity.this, IDCardActivity.class);
    ...
    private void initAccessTokenWithAkSk() {
        ...
        }, getApplicationContext(),  "tYuc9vFxamG1t6hO09p0I8EY", "P5MTkPdUccnvtX2TwNFiubehZyg107YM");
    }
